                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                ...
                                <a href="{{ route('employee.register-bookings.index') }}" type="submit"
...
@section('script')
    <script>
        ...
        function createNewBooking() {
            ...
            fetch("{{ route('employee.register-bookings.store') }}", {
                    method: "POST",
                    headers: {
                ...
                .then(data => {
                    ...
                    if (data.status === 'success') {
                        swal(data.msg, "", "success")
                            .then(() => {
                                window.location.href = "{{ route('employee.register-bookings.index') }}";
                            });
                    } else {
